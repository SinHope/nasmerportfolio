...
const WorkExperience = (props) => {
    return (
        <div className="mt-[50px] ml-[1px] grid grid-cols-2 gap-4">
            <ul className="border-solid border-2 border-violet-900 rounded-full w-60 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-2xl">
                <li className="text-center ml-[0px] hover:text-lg font-sans font-extrabold text-lg mt-[20px]">Procurement Executive<p className="text-sm font-bold ">(Current)(3+years) </p></li>
            </ul>
            <ul className="border-solid border-2 border-violet-900 rounded-full w-60 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-2xl">
            ...
            <ul className="border-solid border-2 border-emerald-500 w-60 bg-emerald-200 shadow-2xl ">
