...
const WorkExperience = (props) => {
    return (
        <div className="mt-[50px] ml-[1px] grid grid-cols-2 gap-4 motion-safe:animate-fadeIn">
            <ul className="border-soliD cursor-pointer d border-2 border-violet-900 rounded-full w-60 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-2xl motion-safe:animate-fadeIn">
